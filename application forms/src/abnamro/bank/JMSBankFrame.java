...
public class JMSBankFrame extends JFrame implements PropertyChangeListener {
	 ...
	 */
	public JMSBankFrame() {
		//loanbrokerApp.addPropertyChangeListener(this);
		...
		btnSendReply.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (/*rr!= null &&*/ reply != null){
					...
					loanbrokerApp.SendReply(reply, null);
				}
			}
		});
	...
	public void propertyChange(PropertyChangeEvent evt) {
		List<RequestReply> requestReplyList = (List<RequestReply>) evt.getNewValue();
		for (RequestReply requestReply : requestReplyList){
